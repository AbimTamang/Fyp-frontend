  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Delay before routing to allow reading the success message
        ...
        <div className="signup-success-overlay">
          <div className="signup-success-modal">
            <div className="success-icon-wrapper">
              <svg className="success-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="20 6 9 17 4 12"></polyline>
              </svg>
            </div>
            <h3>Account Created!</h3>
            <p>Your account has been successfully created. You will be redirected to the login page shortly.</p>
